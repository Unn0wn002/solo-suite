---
description: Roll up project status - progress, blockers, decisions, risks, next step
argument-hint: [optional - for standup, or just to re-orient]
---
Use the project-memory-manager skill in project-status mode. $ARGUMENTS
