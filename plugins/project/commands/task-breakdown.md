---
description: Break the PRD/architecture into an ordered, right-sized task list
argument-hint: [feature or scope, or whole MVP]
---
Use the product-manager skill in task-breakdown mode for: $ARGUMENTS
