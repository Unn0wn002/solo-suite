---
description: Map a user flow - steps, decision points, and the error/empty/edge states
argument-hint: [the goal or journey to map]
---
Use the ui-ux-designer skill in UX-flow mode for: $ARGUMENTS
