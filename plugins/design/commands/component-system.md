---
description: Define a lightweight component system - design tokens + core components with states
argument-hint: [product or brand context]
---
Use the ui-ux-designer skill in component-system mode for: $ARGUMENTS
