---
description: Review a UI for hierarchy, consistency, clarity, simplicity, and forgiveness
argument-hint: [screen description, screenshot, or page/component]
---
Use the ui-ux-designer skill in UI-review mode for: $ARGUMENTS
